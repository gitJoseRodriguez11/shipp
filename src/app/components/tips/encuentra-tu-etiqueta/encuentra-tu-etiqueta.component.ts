...
@Component({
  selector: 'app-encuentra-tu-etiqueta',
  standalone: true,
  imports: [NgxSpinnerModule],
  templateUrl: './encuentra-tu-etiqueta.component.html',
  styleUrl: './encuentra-tu-etiqueta.component.css'
})
export class EncuentraTuEtiquetaComponent implements OnInit{
