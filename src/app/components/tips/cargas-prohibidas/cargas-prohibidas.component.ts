...
@Component({
  selector: 'app-cargas-prohibidas',
  standalone: true,
  imports: [NgxSpinnerModule],
  templateUrl: './cargas-prohibidas.component.html',
  styleUrl: './cargas-prohibidas.component.css'
})
export class CargasProhibidasComponent implements OnInit{
