...
@Component({
  selector: 'app-embalaje-etiquetado',
  standalone: true,
  imports: [NgxSpinnerModule],
  templateUrl: './embalaje-etiquetado.component.html',
  styleUrl: './embalaje-etiquetado.component.css'
})
export class EmbalajeEtiquetadoComponent implements OnInit{
