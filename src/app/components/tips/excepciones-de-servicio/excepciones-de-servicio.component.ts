...
@Component({
  selector: 'app-excepciones-de-servicio',
  standalone: true,
  imports: [NgxSpinnerModule],
  templateUrl: './excepciones-de-servicio.component.html',
  styleUrl: './excepciones-de-servicio.component.css'
})
export class ExcepcionesDeServicioComponent implements OnInit{
